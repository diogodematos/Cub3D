...
/*   Updated: 2023/11/23 15:31:56 by brolivei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_forward(t_main *main)
{
	if (main->world_map[(int)(main->raycast->pos_x
			+ main->raycast->dir_x * 0.05)]
		[(int)(main->raycast->pos_y)] != '1' && main->world_map[(int)(main->raycast->pos_x
			+ main->raycast->dir_x * 0.05)]
	...
	if (main->world_map[(int)(main->raycast->pos_x)]
		[(int)(main->raycast->pos_y + main->raycast->dir_y * 0.05)] != '1' && main->world_map[(int)(main->raycast->pos_x)]
		[(int)(main->raycast->pos_y + main->raycast->dir_y * 0.05)] != '2')
	{
...
void	ft_move_left(t_main *main)
{
	...
	if (main->world_map[(int)(main->raycast->pos_x + move_x)]
		[(int)(main->raycast->pos_y)] != '1' && main->world_map[(int)(main->raycast->pos_x + move_x)]
		[(int)(main->raycast->pos_y)] != '2')
		main->raycast->pos_x += move_x;
	if (main->world_map[(int)(main->raycast->pos_x)]
		[(int)(main->raycast->pos_y + move_y)] != '1' && main->world_map[(int)(main->raycast->pos_x)]
		[(int)(main->raycast->pos_y + move_y)] != '2')
